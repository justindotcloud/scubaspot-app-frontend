    ...
    <AppScreen className="w-full">
      ...
      >
        <div className="px-4 py-6">
          ...
          <div className="mt-6 rounded-lg bg-primary-500 px-3 py-2 text-center text-sm font-semibold text-white">
            Invite person
          </div>
        </div>
      </MotionAppScreenBody>
      ...
      >
        <div className="px-4 py-6">
          <div className="space-y-4">
            ...
            <div className="rounded-lg bg-primary-500 px-3 py-2 text-center text-sm font-semibold text-white">
              Buy shares
            </div>
          </div>
        </div>
    ...
    >
      ...
      <div className="relative col-span-6">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
          <CircleBackground color="#4800FF" className="animate-spin-slower" />
        </div>
