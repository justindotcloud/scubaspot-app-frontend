...
const plans = [
  ...
  },
  {
    ...
    logomarkClassName: 'fill-primary-500',
  },
]
        ...
        <div className="mt-8 flex justify-center">
          <div className="relative">
            ...
            <div
              aria-hidden="true"
              className={clsx(
                'pointer-events-none absolute inset-0 z-10 grid grid-cols-2 overflow-hidden rounded-lg bg-primary-500 transition-all duration-300',
                activePeriod === 'Monthly'
